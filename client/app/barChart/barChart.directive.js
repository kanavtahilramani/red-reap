  ...
  .directive('barChart', function (User) {
    return {
      ...
      link: function (scope, element, attrs) {
    	...
    	else if (curAction == "Length/Score")
    	{
    		var data = User.getUserData().data.comMeta;
			...
			var tip = d3.tip()
			  ...
			  .offset([-10, 0])
			  .html(function(d) {
			    return "<strong>length:</strong> <div style='color:#D9230F;text-align:center;'>" + d.length + " </div>" + "<strong>score:</strong> <div style='color:#D9230F; text-align:center;'>" + d.score + "</div>";
			  });
